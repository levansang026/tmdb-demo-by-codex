...
- **Entitlements File**: `Config/TMDBNetflix.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/TMDBNetflix.entitlements`:
